...
//custom
const u32 gTrainerFrontPic_Custom1[] = INCBIN_U32("graphics/trainers/front_pics/custom1_front.4bpp.lz");
const u32 gTrainerPalette_Custom1[] = INCBIN_U32("graphics/trainers/palettes/custom1.gbapal.lz");